...
// 26 configurable module identifiers.
const MODULOS = [
  "dashboard",
  "pos",
  "entradas",
...
// Matrix: modulo -> [TERMINAL, CAJA, SUPERVISOR, BODEGA]
const MATRIX = {
  dashboard: [V, N, V, V],
  pos: [VC, N, N, N],
  entradas: [N, N, VCE, VC],
...
const ROLES = ["TERMINAL", "CAJA", "SUPERVISOR", "BODEGA"];
...
try {
  ...
  console.log(
    "Seed completado: ubicaciones, admin, ticket_folio y matriz de permisos para TERMINAL, CAJA, SUPERVISOR y BODEGA.",
  );
  console.log(
