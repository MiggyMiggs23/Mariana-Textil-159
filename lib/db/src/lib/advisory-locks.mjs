...
async function run(executor, kind, namespace, key) {
...
export async function sessionAdvisoryLock(executor, namespace, key = 0) {
  await run(executor, "pg_advisory_lock", namespace, key);
}
