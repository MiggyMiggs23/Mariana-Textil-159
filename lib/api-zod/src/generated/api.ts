...
export const CrearTicketBody = zod.object({
  ...
  "lineas": zod.array(zod.object({
  "rolloId": zod.number().nullable().describe('Obligatorio para venta NORMAL de rollo completo; debe ser null en tickets METREADO hasta habilitar el tipo por línea.'),
  "productoId": zod.number(),
