...
collection_row_match = re.search(r'(<div data-preview="collection-detail-row".*?</div>\s*</div>\s*</div>)', rest, re.DOTALL)
                    ...
                    return (
                      <>
                        ...
                        {header ? renderDestinationCard(
                          ...
                          header.previousDesde && header.previousHasta ? detailHref("TODAS", ["CREDITO"], { desde: format(parseISO(header.previousDesde), "yyyy-MM-dd"), hasta: format(parseISO(header.previousDesde), "yyyy-MM-dd"), compare: null, preset: "custom" }) : detailHref("TODAS", ["CREDITO"]),
                          true,
