...
export type Purchase = { id?: number; folio?: string; fecha?: string; subtotal?: string; iva?: string; total?: string; metros?: string; kilos?: string; rollosMetros?: string; rollosKilos?: string; metrajeMetros?: string; margen?: string | null; lineasSinCosto?: number };
export type Purchases = { clienteId: number; periodo?: { desde: string | null; hasta: string | null }; compras: Purchase[]; total: number };
export type Stats = { clienteId: number; periodo?: { desde: string | null; hasta: string | null }; totalCompras?: string; comprasCount?: number; metros?: string; kilos?: string; rollosMetros?: string; rollosKilos?: string; metrajeMetros?: string; costo?: string | null; margen?: string | null; lineasSinCosto?: number };
