...
export type Purchase = { id?: number; folio?: string; fecha?: string; subtotal?: string; iva?: string; total?: string; metros?: string; kilos?: string; margen?: string | null; lineasSinCosto?: number };
export type Purchases = { clienteId: number; periodo?: { desde: string | null; hasta: string | null }; compras: Purchase[]; total: number };
export type Stats = { clienteId: number; periodo?: { desde: string | null; hasta: string | null }; totalCompras?: string; comprasCount?: number; metros?: string; kilos?: string; costo?: string; margen?: string; lineasSinCosto?: number };
...
export type GlobalAnalytics = { periodo: { desde: string | null; hasta: string | null }; ventas: string; tickets: number; costo: string; margen: string; lineasSinCosto: number; metros: string; kilos: string; topVentas: Array<{ id: number; nombre: string; ventas: string; margen: string }>; topMargen: Array<{ id: number; nombre: string; ventas: string; margen: string }>; pareto: Array<{ id: number; nombre: string; ventas: string; acumulado: string }>; publicoVsRegistrado: Array<{ segmento: string; ventas: string; tickets: number }>; mensual: Array<{ mes: string; ventas: string; margen: string }> };
