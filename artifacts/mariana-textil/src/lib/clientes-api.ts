...
export type Stats = { clienteId: number; periodo?: { desde: string | null; hasta: string | null }; totalCompras?: string; comprasCount?: number; metros?: string; kilos?: string; bolsas?: string; rollosMetros?: string; rollosKilos?: string; rollosBolsas?: string; metrajeMetros?: string; metrajeBolsas?: string; costo?: string | null; margen?: string | null; lineasSinCosto?: number };
