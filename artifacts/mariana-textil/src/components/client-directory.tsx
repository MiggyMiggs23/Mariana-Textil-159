...
export function ClientDirectory({ enabled, canFinances, isAdmin, authPartition }: {
  ...
  const [sort, setSort] = useHistoryEntryState<Sort>("clientes.directory.sort", "lastActivity");
  const [direction, setDirection] = useHistoryEntryState<"asc" | "desc">("clientes.directory.direction", "desc");
