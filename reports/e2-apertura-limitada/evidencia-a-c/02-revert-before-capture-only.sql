...
DROP TRIGGER e2_source_insert_transaction ON public.movimientos_credito;
DROP TRIGGER e2_retained_insert_transaction ON public.cobros_credito_pendientes_e1;
DROP FUNCTION public.e2_stamp_insert_transaction();
ALTER TABLE public.movimientos_credito DROP COLUMN e2_insert_xid;
ALTER TABLE public.cobros_credito_pendientes_e1 DROP COLUMN e2_insert_xid;
COMMIT;