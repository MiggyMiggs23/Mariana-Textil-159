export const E3_MATRIX_RELEASED = false;
...
export const MATRIX = Object.freeze({
  ...
  salidas: [V, N, VCE, VC, VCE, V],
  movimientos: [N, N, V, V, VCE, V],
  etiquetas: [N, N, VC, VC, VC, N],
  inventario: [V, N, V, V, V, V],
  auditoria_inventario: [N, N, VCE, VCE, VCE, N],
  productos: [V, N, V, N, VCE, V],
  precios: [N, N, N, N, VCE, V],
  ajustes: [N, N, VC, VC, VC, N],
  clientes: [VCE, N, VCE, N, VCE, V],
  clientes_credito: [V, N, N, N, V, V],
  clientes_precios: [V, N, N, N, V, V],
  clientes_finanzas: [N, N, N, N, V, V],
  ...(E3_MATRIX_RELEASED ? {
    caja_abonos: [N, N, N, N, N, N],
    clientes_recapturas: [N, N, N, N, N, N],
  } : {}),
  proveedores: [N, N, VCE, N, VCE, V],
  proveedores_finanzas: [N, N, N, N, V, VCE],
  contenedores: [N, N, VCE, N, VCE, V],
  ubicaciones: [N, N, N, N, VCE, N],
  usuarios: [N, N, N, N, VCE, N],
  permisos: [N, N, N, N, VE, N],
  resumen_caja: [N, N, N, N, N, V],
  cortes: [N, N, N, N, N, V],
  ...
  salidas_venta: [N, N, N, N, N, N],
  equipos: [N, N, N, N, VCE, N],
});
