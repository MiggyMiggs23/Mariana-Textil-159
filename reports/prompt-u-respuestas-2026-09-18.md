...
Transcripción histórica, conservada sin reescribir las palabras del propietario. La regla vigente de actores queda sustituida por la decisión de la Tanda A del 2026-09-22, registrada debajo: recaptura exclusivamente ADMIN, conservando la guarda E1.
...
- La recaptura conserva el efecto contable de crédito que corresponda; no es un nuevo ingreso, no entra al corte y requiere motivo. Solo ADMIN puede capturarla. Se conserva la guarda E1 que excluye a CONTADOR, SISTEMAS y BODEGA; ningún permiso de matriz supera esa exclusión.
...
La decisión expresa conserva la guarda E1 y deja la recaptura solo para ADMIN. CONTADOR, SISTEMAS y BODEGA no pueden capturar recapturas, aunque reciban otro permiso de matriz. SUPERVISOR, CAJA y TERMINAL tampoco quedan autorizados para recapturar por su autorización general como actores de crédito. El pendiente queda resuelto sin cambiar ni sortear la validación. Los otros componentes E3 continúan su preparación apagada. Esto no se confunde con la separación compatible entre sesión operativa y evidencia de efectivo de una transferencia.