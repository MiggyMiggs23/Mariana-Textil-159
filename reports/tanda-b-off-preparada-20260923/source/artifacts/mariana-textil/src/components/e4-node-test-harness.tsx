...
export function resetHarness() {
  ...
  for (const name of ["useObtenerCorteCaja", "useObtenerTicket", "useObtenerProyeccionAutorizacionNota", "useListLocations"]) {
    hooks[name] = (...args: any[]) => {
