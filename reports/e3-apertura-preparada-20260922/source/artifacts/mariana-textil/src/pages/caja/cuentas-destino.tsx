...
import {
  ...
  formatCentsAsMoney,
} from "@/lib/cuentas-destino-financial";
    ...
    ? [
        {
          ...
          breakdown: [
            { label: "Contado cobrado", amount: header.vendido.contado, fuentes: ["POS"] as ListAdminCuentaDestinoMovimientosFuenteItem[] },
                      ...
                      <Card key={stat.title} className={`relative overflow-hidden ${stat.className} h-full flex flex-col`}>
                        <CardContent className="p-6 flex-1 flex flex-col">
                          ...
                          <Link
                            ...
                            data-testid="text-monto-cobrado"
                          >
