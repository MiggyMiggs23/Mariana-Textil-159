...
export type Purchase = { id: number; folio?: string; fecha?: string; documentoTipo: "TICKET" | "NOTA"; subtotal?: string; iva?: string; total?: string; metros?: string; kilos?: string; bolsas?: string; rollosMetros?: string; rollosKilos?: string; rollosBolsas?: string; metrajeMetros?: string; metrajeBolsas?: string; margen?: string | null; lineasSinCosto?: number };
export function saleTypeLabel(documentoTipo: Purchase["documentoTipo"] | null | undefined) {
  return documentoTipo === "NOTA" ? "Crédito" : documentoTipo === "TICKET" ? "Contado" : "No disponible";
}
