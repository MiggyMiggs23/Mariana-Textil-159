      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="analisis">
            <details className="rounded-lg border bg-card p-4" data-testid="client-analytics-details">
              <summary className="cursor-pointer font-semibold">Desgloses y análisis de clientes por periodo</summary>
              <div className="mt-4">
