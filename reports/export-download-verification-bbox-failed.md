...
|---|---|---|---|---:|---|---|---|
| ventas | normal | **FAILED** | — | — | — | export-content-or-geometry-criterion; diagnosticHash=`fc8ac79ecb460bf970419e83f814e5a42500fe1324b1ec7d99a638bf7567db26` | false |

Control Comparar: no quedó un caso PASS del comparativo para comprobar sus siete bloques.
En cada caso Comparar se midieron los títulos de paneles, límites de columnas y solapes
mediante `pdftotext -bbox` independiente; no se usó otro PDF del mismo generador como esperado.
