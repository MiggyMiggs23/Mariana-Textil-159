import {routes as offRoutes,assertHttpContract} from "./http-off-contracts.mjs";
...
function snapshot() {
  ...
  return {...fingerprints(c),auxiliarySha256:auxiliaryFingerprint(readAux()),tables,sequences};
}
