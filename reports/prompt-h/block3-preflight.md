...
- Captura UTC: `2026-09-16T03:48:10.327Z`
- Captura Ciudad de México: `2026-09-15 21:48:10,327`
...
- Freshness contra snapshot verificado de Bloque 2: **MATCHES_VERIFIED_BACKUP_AT_CAPTURE**.
- Snapshot fuente actual: `.local/backups/prompt-h-block2-20260915214248-7517/source-snapshot.json`; backup directory `.local/backups/prompt-h-block2-20260915214248-7517`; dump SHA-256 `da7d3f7f342756511c6a04d000f0f4f4fa3feea6b9caad21e6abec5213dffb22`.
...
| api_paused_before_after_backup_and_drive | PASS | reports/prompt-h/renovacion-api-pausado.md |
...
| verified_backup_snapshot_shape | PASS | .local/backups/prompt-h-block2-20260915214248-7517/source-snapshot.json |
...
| A | sesiones | 11 | ea64f311a46b7247f621b2f5c9bddd1c |
...
Tickets A evidenciados: **6**; tickets tipo NOTA: **2**; autorizaciones de nota asociadas: **2** (tabla `autorizaciones_nota`: **2**).
...
Snapshot verificado: `2026-09-16T03:42:48.408Z`; captura actual: `2026-09-16T03:48:10.327Z`.
- Datos por tabla (conteos/huellas): **MATCH**.
- Metadatos semánticos: **MATCH**.
- Estado de secuencias contra respaldo: **MATCH**.
