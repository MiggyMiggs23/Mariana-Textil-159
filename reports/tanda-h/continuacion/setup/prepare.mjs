...
let text=fs.readFileSync(root+"/reports/tanda-f/setup/prepare.mjs","utf8")
 ...
 .replaceAll('"TFA","TFB","TFC"','"HAA","HAB","HAC"').replaceAll("55440","55445").replaceAll("994000000","997000000")
 ...
 .replace('["browser","concurrency","permissions","reversal"]','["browser"]')
 .replace('["template","browser","concurrency","permissions","reversal","witness"]','["template","browser","witness"]')
