...
// Candidate counterpart of scripts/api-start-audit-record.mjs. No secret output.
const [pid, stage, status, preflightExit, exitCode] = process.argv.slice(2);
let sha256 = null;
let hashError = null;
try {
  sha256 = createHash("sha256")
    .update(readFileSync("artifacts/api-server/dist-e2-20260927/index.mjs")).digest("hex");
} catch (error) {
