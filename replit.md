...
**Precio mínimo — preparación inactiva autorizada el 2026-09-19:** el precio de lista no tiene techo para subir; para bajar, el mínimo es el costo. El bloqueo está preparado en la mutación individual/masiva de Precios y su interfaz, con puertas cerradas; no cambia el bundle servido ni se presenta como vigente. La «confirmación bajo costo» anterior no es el comportamiento objetivo. Costo desconocido, alta sin costo, otras rutas de edición/importación y la discrepancia entre ADMIN documental y matriz actual quedan pendientes antes de liberar; no se inventa su tratamiento. Alcance en «Decisiones futuras — remate, precios y purga».
...
1. **Remate — preparación parcial inactiva; conflicto de matriz RESUELTO.** «Marcar remate» es un permiso configurable preparado que por defecto solo tiene ADMIN, sin techo fijo de roles. Hay handler, adaptador y componente sin montar, con puertas cerradas, por rollo y con motivo obligatorio; no se expone al frontend servido. El contrato/montaje canónico, la integración de venta bajo costo, la señal de remate y su pérdida en utilidad permanecen detenidos por la frontera de archivos protegidos. No se declara remate completo ni liberable. La regla objetivo sigue siendo que solo esos rollos puedan venderse bajo costo, sin ampliar la marca a todo el producto ni permitir al cajero eludir permisos. Edición/retiro de marca requieren decisión.
2. **Precios — bloqueo preparado e inactivo junto con remate.** El precio de lista no tiene techo para subir. Para bajar, el mínimo es el costo; el helper real de precio y su UI contienen el bloqueo bajo puertas cerradas, sin alterar el cálculo canónico de costo. Costo desconocido/alta sin costo y otras rutas de edición/importación no quedan resueltos; son bloqueos de liberación, no autorizaciones implícitas ni cobertura completa de precios.
