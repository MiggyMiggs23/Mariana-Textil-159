...
**Verificación ejecutada en esta entrega:** 26 pruebas acotadas pasaron; se completó el chequeo de tipos de todos los proyectos y quedaron **cuatro errores únicos preexistentes**, no dos: los dos conocidos de API y dos usos de `pendiente` en Alertas ausentes de su contrato anterior. No se corrigieron. No hay errores nuevos restantes. El navegador no quedó aprobado: no había sesión real y los fixtures simulados fallaron antes de montar la tabla. Tampoco se acredita persistencia financiera real. Resultado y salidas: `reports/abonos-fifo-2026-09-15-resultado.md`.
...
- La simulación histórica de solo lectura encontró **dos notas cuyo saldo se reduciría y cero que quedarían pagadas** al retirar indiscriminadamente el veto. Se preservan las marcas y saldos existentes. La excepción histórica transitoria no se oculta mediante neteo ni se presenta como cumplimiento universal de la nueva invariancia.
- Bloque 4: reversos totales y recapturas preparados en `reports/abonos-fifo-2026-09-15-plan-bloque-4.md`, **no ejecutados**, pendientes de autorización expresa. El reverso existente usa la fecha de ejecución y no reclasifica por sí solo el corte del día erróneo.
