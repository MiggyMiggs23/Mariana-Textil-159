...
**Alcance de apertura E3 decidido en Parte 2 (2026-09-22), aún no liberado:** la futura liberación E3 incluye captura ordinaria de efectivo. Retiro dirigido/retenido, devolución, atribución y Fondo permanecen cerrados. La preparación autorizada usa expectativas READ ONLY de la conexión efectiva de la API y bases PostgreSQL nuevas desechables; SQL 01 y el retiro acotado de la guarda ordinaria SQL 03 solo se ensayan allí. La fuente que sirve desarrollo conserva sus gates OFF; el candidato operativo se prepara mediante activación explícita en copia física aislada. Esta decisión no autoriza ejecutar fase B, escribir en la base de la API, reiniciar su proceso ni alterar workflow, bundle activo, E2 o el candidato CLOSED anterior. Autorización íntegra: `reports/e2-liberacion-20260922/autorizacion-tres-partes-20260922.txt`.
