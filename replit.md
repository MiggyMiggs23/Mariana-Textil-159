...
**Conflicto E3/matriz frente a actores E1 — pendiente del propietario:** E1 conserva su lista de actores de crédito ADMIN/SUPERVISOR/CAJA/TERMINAL; CONTADOR, SISTEMAS y BODEGA siguen excluidos. El nuevo permiso configurable de recaptura no elimina esa restricción heredada: concederlo a uno de esos tres roles no bastaría para operar. No se amplía la lista ni se elude la guarda por esta construcción. La autorización efectiva para esos roles queda detenida; los demás componentes se preparan apagados. Evidencia y límites en `reports/e3-20260921/backend.md`.
