...
Fuente y autorización escrita del propietario: `reports/autorizacion-procedimiento-simple-y-liberacion-e3-tanda-b-20260923.txt`. Esta regla rige **solo mientras nadie opere el sistema y todos sus datos sean de prueba**. Antes de cualquier escritura en la base de la API sigue siendo obligatoria una autorización escrita del propietario. La fuente citada autoriza, únicamente para esta liberación y en este orden, aplicar el SQL preparado de E3, arrancar el candidato real, exigir `/api/healthz` HTTP 200 y verificar E3; después autoriza aplicar el SQL preparado y liberar la Tanda B (E4, E12, E9, E5, E11 y E7). E3 abre efectivo ordinario. Dirigido, retenido, devolución, atribución, Fondo y remate continúan cerrados; toda puerta no abierta expresamente por escrito permanece apagada.
