...
- **Pendiente: historial de reimpresiones por rollo.** Falta una pantalla de historial individual. Por decisión del usuario, no construirla ahora y retirar solo el enlace pendiente al historial. El bloque «Rollos con tres o más reimpresiones» conserva su enlace al detalle del rollo en `/inventario/rollos/:id`. Se conservan los registros de reimpresión, sus conteos y el detalle del rollo; este acceso no se presenta como un historial completo.
