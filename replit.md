...
**Restricción vigente de arranque:** no arrancar ni reiniciar la API automáticamente al terminar código, documentación, pruebas o migración; tampoco iniciar workflows, inicializadores o mantenimiento sin autorización. La pausa registrada el 17 de septiembre es un antecedente histórico. Durante la preparación de apertura limitada del 18 de septiembre se conservó el proceso anterior, sin reiniciarlo; un reinicio externo del workspace al finalizar detuvo ambos workflows. No se arrancaron después. La recuperación propuesta en `reports/e2-apertura-limitada/recuperacion-anterior-propuesta.md` requiere autorización separada y no habilita capturas nuevas.
