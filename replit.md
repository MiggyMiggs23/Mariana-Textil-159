...
**Estado al 18 de septiembre de 2026: las tres guardas temporales están instaladas también en la operativa `heliumdb`: PASS / COMMITTED_VERIFIED, seis instrucciones DDL y 15/15 controles posteriores PASS.** La ventana normal autorizada confirmó identidad desde el pool real, con bloqueo HTTP probado antes de cargar la aplicación y parada antes del DDL. Se validaron los **60 objetos y sus definiciones**, las siete columnas E1 y la ausencia previa de guardas. El backfill insertó **0 filas**; el arranque sólo cambió timestamps de 70 permisos de rol y 54 de ubicación y avanzó sus dos secuencias, documentado aparte. Las 66 tablas, tres históricos, catálogo permanente y 47 secuencias se conservaron durante instalación/sondas contra la línea base posterior al arranque. **API PAUSADA; sin autorización para operación normal. No arrancar ni reiniciar automáticamente API, workflow, inicializadores o mantenimiento. E1 no se declara cerrado en su totalidad por esta intervención.** Informe actual: [resultado-operativo.md](reports/e1-guardas-operativa-2026-09-18/resultado-operativo.md). Autorización: [autorizacion-ventana-e-instalacion.md](reports/e1-guardas-operativa-2026-09-18/autorizacion-ventana-e-instalacion.md). Los NO-GO anteriores y la aclaración de 27 sentencias frente a 60 objetos se conservan como antecedentes, no como bloqueos vigentes.
