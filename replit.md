...
**Estado al 17 de septiembre de 2026: DDL operativo aplicado y conservación verificada; código E1 implementado. Tras detectar tres brechas SQL en el ensayo del clon, se comprobaron tres guardas independientes con 84/84 controles: instaladas SÓLO en el clon y pendientes de autorización operativa separada. E1 NO cerrado. API PAUSADA y debe permanecer pausada. No arrancar ni reiniciar automáticamente la API, su workflow, inicializadores o mantenimiento.** La autorización de escritura libre del propietario cubre exclusivamente el clon desechable existente; está en [autorizacion-ensayo-clon.md](reports/e1-ejecucion-2026-09-17/autorizacion-ensayo-clon.md), ampliada para las guardas en [autorizacion-guardas-clon.md](reports/e1-ejecucion-2026-09-17/autorizacion-guardas-clon.md). No autoriza nuevas escrituras operativas ni activación de capturas.
...
**Corrección posterior de las tres brechas en el clon:** 84/84 controles, incluidas recepción y devolución física, compatibilidad SQL de los siete productores, retirada independiente y reinstalación exacta. Instalación conjunta hasta COMMIT confirmado: 29.141 ms; ejecución supervisada: 5.689 s, sin extrapolar esos tiempos a la operativa. Las 66 tablas, 55 funciones y 23 triggers permanentes conservaron sus filas/definiciones. Las tres guardas nuevas quedan instaladas en el clon; la operativa espera autorización. Efectivo se retira con E2+E3 completos; pendientes con E3+E5 y lectores/aprobaciones listos; atribución histórica sólo con autorización específica, no automáticamente al habilitar Caja.
