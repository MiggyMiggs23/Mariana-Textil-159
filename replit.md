...
Las tarjetas se separan en dos filas porque responden preguntas distintas. La fila principal muestra el dinero, en el orden fijo **Ventas (Total) → Cobrado (Caja) → Ventas a crédito → Utilidad**. La fila secundaria muestra señales operativas, en el orden fijo **Ventas pendientes de cobro o autorización → Tickets cancelados → Salidas en tránsito → Salidas canceladas**. Sus cuatro tarjetas tienen menos altura y una cifra menor que las de la primera fila: se consultan cuando requieren atención, pero no deben competir visualmente con las identidades principales del negocio. En pantallas estrechas ambas filas se apilan conservando ese orden.
