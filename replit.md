...
- **Restricción provisional de Control operativo (2026-09-14):** la vista completa y sus exportaciones permanecen restringidas a ADMIN como medida de contención, no como regla permanente del sistema. **Razón:** reunir fuentes con autorizaciones distintas permitió exponer información reservada; el bloqueo completo cierra esa exposición mientras se evalúa la autorización por bloque. Es más restrictivo que las pantallas de origen y no cambia sus permisos: por ejemplo, CONTADOR y SISTEMAS conservan Cuentas destino fuera de Control. La autorización granular no está implementada ni autorizada en esta entrega. Antes de retirar el bloqueo, reutilizar la política de cada fuente, autorizar antes de consultar, conservar alcance de sitio y restricciones económicas, y verificar paridad entre pantalla, XLSX y PDF. Estimación orientativa: 24–40 horas técnicas, incluida verificación; sin migración de base prevista.
