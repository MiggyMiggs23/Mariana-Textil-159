...
**Bloqueo de apertura impuesto por el propietario:** no activar la captura limitada hasta resolver la evidencia que exige la devolución. Presentar, sin elegir ni implementar por cuenta propia, estas alternativas: generar la prueba desde el primer abono, admitir otra evidencia suficiente o posponer hasta que E2 pueda devolver. Una aceptación genérica de la carencia de evidencia no satisface esta condición. Recuperar el bundle anterior y hacer el primer corte con tickets no resuelve ni levanta este bloqueo.
...
Verificación de esta preparación: 67/67 en aplicación, 17/17 en arranque; candidato frontend 2/2 cerrado, 4/4 activo y 7/7 de contrato; SQL estructural y 10 negativos. Typecheck canónico final exit 0/cero diagnósticos. Los mismos manifiestos de baseline contienen ahora 154 pruebas (una prueba de guarda global fue sustituida por seis): 149 PASS y exactamente los cinco fallos previos, sin nuevos. Reconfirmación final acotada y hashes en `reports/e2-apertura-limitada/verificacion/final-reconfirm-summary.txt`. No se ejecutó PostgreSQL para estas comprobaciones ni se activó el flujo.
