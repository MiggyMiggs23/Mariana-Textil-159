...
Fuente inicial y autorización escrita del propietario: `reports/autorizacion-procedimiento-simple-y-liberacion-e3-tanda-b-20260923.txt`. Esta regla rige **solo mientras nadie opere el sistema y todos sus datos sean de prueba**. Antes de cualquier escritura en la base de la API sigue siendo obligatoria una autorización escrita del propietario. Esa fuente autorizó aplicar E3 y los cinco SQL de Tanda B, ya instalados y no repetibles. La autorización posterior `reports/tanda-d-20260923/autorizacion.txt` abrió remate, precio mínimo, borrado individual de producto sin movimientos y E11 limitado; `reports/e4-liberacion-20260923/autorizacion.txt` abrió E4 separado de E12. La autorización vigente `reports/liberacion-e9-e7-e11-20260923/autorization.txt` permite trabajar E9 documental sin ingreso al Fondo, lectores financieros E7 sin operaciones E5 ni atribución, y el selector ADMIN de perfiles E11 sin asignar usuarios ni abrir preparación E5. E9 quedó técnicamente bloqueado al fallar AUTORIZAR con PostgreSQL 22P02; sus gates API/UI se restauraron OFF y no se aplicó su SQL a la base efectiva. E7 y el selector E11 permanecen preparados ON, sujetos al cierre de build/runtime documentado en el informe citado. Dirigido, retenido, devolución, atribución, Fondo/E10, E12 y purga general continúan cerrados; toda puerta no abierta expresamente permanece apagada.
...
**Estado histórico sustituido parcialmente el 2026-09-23:** Grupo 1 no estaba aprobado y grupos 2–4 no se iniciaron. La liberación E7 posterior abre únicamente el resumen global de cuatro cifras y el detalle financiero por sitios autorizados, proyectando FIFO global antes de filtrar y conservando las leyendas en exportaciones. No abre atribución, operaciones E5, grupos 2–4 ni POST de reimpresión. El resultado operativo y sus límites se registran en `reports/liberacion-e9-e7-e11-20260923/INFORME.md`; la preparación ON en fuente no equivale a bundle servido.
...
- **P8 / E9 — sustituye la pregunta 8 pendiente respecto de modalidad de entrega, autor del envío y diferencias:** cada tienda entrega su efectivo completo al cierre. ADMIN o SUPERVISOR documenta el envío. ADMIN cuenta y autoriza en Mariana; una diferencia abre investigación. No se ajusta automáticamente ni se modifica un corte cerrado. La implementación separa custodia de Fondo, pero su liberación del 2026-09-23 quedó **BLOQUEADA**: AUTORIZAR falló en PostgreSQL real desechable con 22P02 dentro de `e9_validate_detail`. E9 API/UI e ingreso Fondo están OFF; no se aplicó el SQL a la base de la aplicación y no se repara dentro de esta tanda.
...
- La implementación E9 documental conserva envío, conteo, autorización de
  custodia e investigación sin conexión monetaria al Fondo, pero está OFF por
  el fallo técnico 22P02 de su validación PostgreSQL. E12 (pagos a proveedor)
  continúa sin conexión ni accesos habilitados. No se reanuda Prompt P ni se
  abre atribución E7.
