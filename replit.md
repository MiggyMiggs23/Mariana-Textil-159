...
Diseño presentado, no implementado: `reports/e2-apertura-limitada/diseno-a-c-antes-de-implementar.md`. La comparación posterior de permisos contra el respaldo E10 confirmó cero diferencias efectivas (3,968 decisiones de acceso), solo timestamps en las filas conocidas: `reports/e2-apertura-limitada/permisos-respaldo/resultado.md`. Esto no resuelve el bundle distinto ni autoriza arrancarlo.
