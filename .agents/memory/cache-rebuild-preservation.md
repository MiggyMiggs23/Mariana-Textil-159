...
**How to apply:** Primero comprobar que el seed autorizado cubre los casos requeridos, siguiendo la regla de población de `replit.md`. La prueba requiere movimientos válidos, mínimos numéricos y pares sin mínimo; guardar también autor, fechas y configuración por sitio. Confirmar tanto la corrección del caché como la igualdad exacta de la configuración. Identificar la base aislada antes de mutar y eliminar únicamente los recursos desechables creados. No sustituir esa evidencia por mocks ni por inspección de esquema.