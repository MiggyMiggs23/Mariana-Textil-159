...
La futura captura debe comprobar que el cajero comprende la distinción, no solamente exigir una selección.

**Why:** El propietario señaló que una pregunta confusa llevaría a contestar cualquier cosa para avanzar y volvería inútil el dato que debe distinguir recapturas de dinero nuevo.

**How to apply:** Es requisito de aceptación de E3, no autorización para diseñar su pantalla durante E1. Verificar comprensión con casos operativos antes de dar por resuelta la captura.