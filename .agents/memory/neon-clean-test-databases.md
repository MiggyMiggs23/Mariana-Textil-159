...
**How to apply:** Obtener una conexión a la base nueva de la rama, ejecutar el flujo normal de push y seed del proyecto y usar esa URL únicamente como `TEST_DATABASE_URL`.